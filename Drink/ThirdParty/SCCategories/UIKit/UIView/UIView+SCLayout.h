...
@property (nonatomic, assign, readonly) CGFloat sc_maxX;    ///< CGRectGetMaxX(self.frame)
@property (nonatomic, assign, readonly) CGFloat sc_maxY;    ///< CGRectGetMaxY(self.frame)

@property (nonatomic, assign, readonly) CGFloat sc_minX;    ///< CGRectGetMinY(self.frame)
@property (nonatomic, assign, readonly) CGFloat sc_minY;    ///< CGRectGetMinY(self.frame)
